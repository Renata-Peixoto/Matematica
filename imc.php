				...
				<div class="row">
					<form class="form-group">
						<div class="col-md-3 col-md-offset-5">	
							<input type="text" name="num1" class="form-control" placeholder="Peso Ex 80" align="center" required> <br>
							<input type="text" name="num2" class="form-control" placeholder="Altura Ex: 1.80" align="center" required><br>
